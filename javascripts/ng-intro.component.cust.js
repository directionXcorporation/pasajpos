(function (root, factory) {
    if (typeof window.define === "function" && window.define.amd) {
        ...
        (root=root||self).angularIntroJs = factory(root.angular, root.introJs);
    }
    ...
    var NgIntroService = (function () {
        ...
        NgIntroService.prototype.onSkip = function (cb) {
            var _this = this;
            return this.intro.onskip(function () {
                _this.notifyListeners(introStatus.closed);
                if (angular.isFunction(cb))
                    cb();
            });
    ...
    var NgIntroDirective = (function () {
        function NgIntroDirective(introService, $timeout) {
            ...
            this.link = function (scope, element, attrs) {
                ...
                if (scope.ngIntroOnskip) {
                    introService.onSkip(scope.ngIntroOnskip);
                }
