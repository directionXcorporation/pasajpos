...
(function (window) {
 ...
 function idb() {
  ...
  var defaultOptionMap = {
    ...
    baseurl: '//sedesoft.com', // base url for php, flash and silverlight assets
    asseturi: '', // assets = .fla, .jar, etc
    phpuri: '', // php file path or route
    authPath: false, //'/evercookie_auth.php', // set to false to disable Basic Authentication cache
    swfFileName: '/javascripts/evercookie/evercookie.swf',
    xapFileName: '/javascripts/evercookie/evercookie.xap',
    jnlpFileName: '/javascripts/evercookie/evercookie.jnlp',
    pngCookieName: 'evercookie_png',
    pngPath: '/javascripts/evercookie/evercookie_png.php',
    etagCookieName: 'evercookie_etag',
    etagPath: '/javascripts/evercookie/evercookie_etag.php',
    cacheCookieName: 'evercookie_cache',
    cachePath: '/javascripts/evercookie/evercookie_cache.php',
    hsts: false,
    hsts_domains: [],
    db: true, // Database
    idb: true // Indexed DB
